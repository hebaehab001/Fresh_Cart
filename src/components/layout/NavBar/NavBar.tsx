...
export default function NavBar() {
  ...
  const { numOfCart } = useCart();
  const { numOfFav } = useWishlist();
                ...
                {status == "authenticated" ? (
                  <span className="gap-2 flex flex-col">
                    ...
                    <Link href="/cart">
                      <Button
                        variant="outline"
                        className="rounded-full w-full hover:bg-white group/hoverc hover:cursor-pointer relative" size={undefined}                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <DropdownMenu>
                      ...
                      >
                        <DropdownMenuGroup>
                          <DropdownMenuItem className="p-2 m-0 w-full flex text-gray-800 hover:bg-white  items-center" inset={undefined}>
                          ...
                          <Link href="/allorders">
                            <DropdownMenuItem className="p-2 m-0 w-full justify-start hover:bg-gray-100 cursor-pointer" inset={undefined}>
                          ...
                          >
                            <DropdownMenuItem className="m-0  p-2 w-full  justify-start hover:bg-gray-100 cursor-pointer" inset={undefined}>
                  ...
                  <span className="gap-2 flex flex-col">
                    <Link href="/register">
                      <Button
                          variant="outline"
                          className="bg-transparent text-white  w-full  cursor-pointer hover:text-sky-900  md:text-lg md:py-5 " size={undefined}                      >
                        register
                      </Button>
                    </Link>
                    <Link href="/login">
                      <Button
                          variant="outline"
                          className="w-full text-sky-900 cursor-pointer md:text-lg md:py-5 hover:bg-transparent hover:text-white" size={undefined}                      >
                        login
                      </Button>
                    </Link>
                  </span>
          ...
          {status == "authenticated" ? (
            ...
            <span className="gap-2 flex">
              <Link href="/register">
                <Button
                    variant="outline"
                    className="bg-transparent text-white  w-full border-0 cursor-pointer hover:text-sky-900  md:text-lg md:py-5 " size={undefined}                >
                  register
                </Button>
              </Link>
              <Link href="/login">
