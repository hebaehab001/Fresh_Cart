                  ...
                  <span className="gap-2 flex flex-col">
                    <Link
                      ...
                      className={buttonVariants({
                        ...
                        variant: "outline",
                        className:
                          "rounded-full w-full hover:to-white hover:from-white group/hoverh relative",
                      })}
                    >
                      <svg
                    ...
                    <Link
                      ...
                      className={buttonVariants({
                        ...
                        variant: "outline",
                        className:
                          "rounded-full w-full hover:to-white hover:from-white group/hoverc relative",
                      })}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          size="default"
                          variant="outline"
                          className="w-full hover:to-white hover:from-white group/hoverp relative"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                      ...
                      >
                        <DropdownMenuGroup>
                          ...
                          >
                            ...
                            >
                              <MdLogout className="text-red-700 group-hover/hoverl:text-white" />
                              <span>Log out</span>
                            </Button>
                          </DropdownMenuItem>
                        </DropdownMenuGroup>
            ...
            <span className="gap-2 flex">
              <Link
                ...
                className={buttonVariants({
                  ...
                  size: "icon",
                  className:
                    "rounded-full! hover:from-white! hover:to-white! group/hoverh relative",
                })}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <Link
                ...
                className={buttonVariants({
                  ...
                  size: "icon",
                  className:
                    "rounded-full! hover:from-white! hover:to-white! group/hoverc relative",
                })}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Avatar className="size-9 ">
                    <AvatarFallback className="group/hoverp cursor-pointer">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="none"
